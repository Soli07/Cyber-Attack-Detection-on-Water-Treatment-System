<!DOCTYPE html>
    ...
    <?php include 'data.php'; ?>
		...
		<div id="timestamp" style="position: absolute; top: 30px; left: 700px; background-color: #f0f0f0; padding: 10px 20px; border-radius: 20px; font-size: 20px; color: red; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);"></div>
        ...
        <div id="p101" style="position: absolute; top:60px; left:395px; color: darkblue; font-size:10px"></div>
        <p style="position: absolute; top:25px; left:377px; color: darkblue;font-size:14px">P-101</p>
		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:15px; left:350px; width: 100px; height: 100px;">
        ...
        <div id="p102" style="position: absolute; top:195px; left:350px; color: darkblue; font-size:10px"></div>
        <p style="position: absolute; top:155px; left:335px; color: darkblue;font-size:14px">P-102</p>
        <p style="position: absolute; top: 280px; left: 300px; color: darkblue;">Raw Water Pumps</p>
		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:150px; left:300px; width: 100px; height: 100px;">
        ...
        <p style="position: absolute; top: 330px; left: 740px; color: darkblue;">NaOCl Tank</p>
         ...
         <p style="position: absolute; top:100px; left:50px; color: darkblue;font-size: 12px">Raw water<br>Inlet valve</p>
        <div id="mv101" style="position: absolute; top:53px; left:75px; color: darkblue; font-size:10px"></div>
         <p style="position: absolute; top:25px; left:60px; color: darkblue;font-size:10px">MV-101</p>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:10px; left:30px; width: 100px; height: 100px;">
        ...
        <div id="lit101" style="position: absolute; top:67px; left:215px; color: darkblue; font-size:10px"></div>
        <p style="position: absolute; top:40px; left:205px; color: darkblue;font-size:10px">LIT-101</p>
		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:22px; left:170px; width: 100px; height: 100px;">
        ...
        <div id="mv201" style="position: absolute; top:180px; left:930px; color: darkblue; font-size:10px"></div>
        <p style="position: absolute; top:180px; left:925px; color: darkblue;font-size:10px">MV-201</p>
        ...
        <div id="lit301" style="position: absolute; top:100px; left:1005px; color: darkblue; font-size:10px"></div>
        <p style="position: absolute; top:70px; left:1005px; color: darkblue;font-size:10px">LIT-301</p>
		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:55px; left:970px; width: 100px; height: 100px;">
        ...
        <div id="p301" style="position: absolute; top:170px; left:1190px; color: darkblue;font-size:15px"></div>
        <p style="position: absolute; top:140px; left:1179px; color: darkblue;font-size:12px">P-301</p>
		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:130px; left:1150px; width: 100px; height: 100px;">
         ...
         <div id="p302" style="position: absolute; top:272px; left:1185px; color: darkblue;font-size:15px"></div>
         <p style="position: absolute; top:245px; left:1179px; color: darkblue;font-size:12px">P-302</p>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:230px; left:1140px; width: 100px; height: 100px;">
        ...
        <img src="water treatment images/chem dosing valve.jpeg" alt="Valve with actuator 3" style="position: absolute; top:95px; left:1340px; width: 100px; height: 100px;">
         <div id="mv302" style="position: absolute; top:110px; left:1385px; color: darkblue;font-size:10px"></div>
         <p style="position: absolute; top:80px; left:1375px; color: darkblue;font-size:10px">MV-302</p>
         <p style="position: absolute; top:165px; left:1373px; color: darkblue;font-size:10px">RO Feed<br>Valve</p>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:65px; left:1340px; width: 100px; height: 100px;">
        ...
        <img src="water treatment images/raw water pump.jpeg" alt="pump 5" style="position: absolute; top:247px; left:1589px; width: 100px; height: 100px;">
         <div id="p402" style="position: absolute; top:257px; left:1685px; color:darkblue;font-size:15px"></div>
        <p style="position: absolute; top:232px; left:1671px; color: darkblue;font-size:12px">P_402</p>
		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:215px; left:1640px; width: 100px; height: 100px;">
        ...
        <img src="water treatment images/raw water pump.jpeg" alt="pump 6" style="position: absolute; top:147px; left:1589px; width: 100px; height: 100px;">
         <div id="p401" style="position: absolute; top:152px; left:1685px; color: darkblue;font-size:15px"></div>
         <p style="position: absolute; top:125px; left:1675px; color: darkblue;font-size:12px">P_401</p>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:110px; left:1640px; width: 100px; height: 100px;">
        ...
        <img src="water treatment images/rofeed level meter 1008.jpeg" alt="sensor reading 3" style="position: absolute; top:90px; left:1426px; width: 100px; height: 100px;">
         <div id="lit401" style="position: absolute; top:90px; left:1466px; color: darkblue;font-size:10px"></div>
         <p style="position: absolute; top:60px; left:1463px; color: darkblue;font-size:10px">LIT-401</p>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:45px; left:1435px; width: 100px; height: 100px;">
        ...
        <p style="position: absolute; top:695px; left:1695px; color: darkblue;font-size:14px">NAHSO3_Tank</p>
         ...
         <div id="p501" style="position: absolute; top:473px; left:1455px; color: darkblue;font-size:14px"></div>
          <p style="position: absolute; top:445px; left:1440px; color: darkblue;font-size:12px">P-501</p>
		  		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:430px; left:1410px; width: 100px; height: 100px;">
         ...
         <div id="p502" style="position: absolute; top:575px; left:1450px; color: darkblue;font-size:14px"></div>
          <p style="position: absolute; top:543px; left:1435px; color: darkblue;font-size:12px">P-502</p>
		  		<img src="water treatment images/border.png" alt="border" style="position: absolute;top:532px; left:1405px; width: 100px; height: 100px;">
         ...
         <img src="water treatment images/vessels.jpeg" alt="RO Vessels 3" style="position: absolute;top:690px; left:1149px; width: 100px; height: 100px;">
          ...
          <div id="mv501" style="position: absolute; top:620px; left:725px; color: darkblue;font-size:10px"></div>
          ...
          <img src="water treatment images/raw water pump.jpeg" alt="CIP Pump" style="position: absolute;top:505px; left:313px; width: 100px; height: 100px;">
            <div id="p603" style="position: absolute; top:540px; left:300px; color: darkblue;font-size:14px"></div>
           <p style="position: absolute; top:515px; left:395px; color: darkblue;font-size:14px">P-603</p>
		   <img src="water treatment images/border.png" alt="border" style="position: absolute;top:500px; left:250px; width: 100px; height: 100px;">
          ...
          <div id="p601" style="position: absolute; top:675px; left:300px; color: darkblue;font-size:14px"></div>
           <p style="position: absolute; top:645px; left:395px; color: darkblue;font-size:14px">P-601</p>
		   <img src="water treatment images/border.png" alt="border" style="position: absolute;top:633px; left:250px; width: 100px; height: 100px;">
         ...
         <img src="water treatment images/raw water pump.jpeg"  alt="UF Backwash Pump" style="position: absolute; top:810px; left:138px; width: 100px; height: 100px;">
          <div id="p602" style="position: absolute; top:900px; left:180px; color: darkblue;font-size:14px"></div>
         <p style="position: absolute; top:818px; left:220px; color: darkblue;font-size:14px">P-602</p>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:859px; left:135px; width: 100px; height: 100px;">
        ...
        <p style="position: absolute; top:792px; left:100px; color:darkblue;font-size:15px">UF Backwash<br>Pump</p>
         ...
         <p style="position: absolute; top:80px; left:1280px; color: darkblue;font-size:10px">MV-301</p>
         <div id="mv301" style="position: absolute; top:110px; left:1290px; color: darkblue;font-size:10px"></div>
		 <img src="water treatment images/border.png" alt="border" style="position: absolute;top:65px; left:1245px; width: 100px; height: 100px;">
         ...
         <div id="mv502" style="position: absolute; top:795px; left:935px; color: darkblue;font-size:10px"></div>
         ...
         <div id="mv503" style="position: absolute; top:720px; left:825px; color: darkblue;font-size:10px"></div>
        ...
        <p style="position: absolute; top:25px; left:140px; color: darkblue;font-size:10px">FIT-101</p>
        <div id="fit101" style="position: absolute; top:50px; left:140px; color: darkblue;font-size:10px"></div>
		<img src="water treatment images/border.png"  alt="border" style="position: absolute; top:5px; left:105px; width: 100px; height: 100px;">

         
         <p style="position: absolute; top: 110px; left: 600px; color: darkblue;font-size:13px">FIT-201</p>
         <div id="fit201" style="position: absolute; top:145px; left:600px; color: darkblue;font-size:10px"></div>
         
         <p style="position: absolute; top: 110px; left: 670px; color: darkblue;font-size:13px">ALT-201</p>
         <div id="ait201" style="position: absolute; top:145px; left:680px; color: darkblue;font-size:10px"></div>

         <p style="position: absolute; top:70px; left:925px; color: darkblue;font-size:10px">ALT-202</p>
        <div id="ait202" style="position: absolute; top:100px; left:925px; color: darkblue;font-size:10px"></div>
