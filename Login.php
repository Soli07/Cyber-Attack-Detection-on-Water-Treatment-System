...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email_err) && empty($password_err)) {
        // Here you would typically query your database to check if the email and password match a record
        // For demonstration purposes, let's assume the email and password are valid if they are not empty
        echo "Email: " . $email . "<br>";
